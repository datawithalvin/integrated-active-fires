...
from src.procedures import fetch_viirs_data, fetch_last_data, cleaning_fetched_data, extract_administrative
...
def main():
    ...
    try:
        ...
        concat_viirs.write_database(table_name="processed_viirs", connection=CONNECTION_URI, if_exists="append")
